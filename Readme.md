...
# Parsing + Configuration Script – FMC130 - Rev. A

This **Parsing + Configuration** script is designed for the **FMC130** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – FMC130 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **FMC130** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
